				...
				for (int d=1; d <= distWhseKount; d++) {
					...
					for (int c=1; c <= custDistKount; c++) {
						...
						if (outputFiles == false)
						{
							...
							//removed timestamp
							custPrepStmt.setString(19, customer.c_middle);
							custPrepStmt.setString(20, customer.c_data);
							...
							//removed timestamp
							histPrepStmt.setDouble(6, history.h_amount);
							histPrepStmt.setString(7, history.h_data);

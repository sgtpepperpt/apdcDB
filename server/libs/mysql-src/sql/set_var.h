...
{
public:
  enum Type {V_SYSTEM, V_USER, V_PASSWORD, V_COLLATION};
  set_var_base() {}
...
public:
  ...
  set_var_base::Type varType() const {return set_var_base::V_SYSTEM;}
};
...
public:
  ...
  set_var_base::Type varType() const {return set_var_base::V_USER;}
};
...
public:
  ...
  set_var_base::Type varType() const {return set_var_base::V_PASSWORD;}
};
...
public:
  ...
  set_var_base::Type varType() const {return set_var_base::V_COLLATION;}
};
